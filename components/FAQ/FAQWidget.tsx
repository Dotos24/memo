...
const faqData: FAQItem[] = [
    ...
    },
    {
        ...
        answer: "Гра проста: виберіть картку, прочитайте запитання та почніть відверту розмову 💭. Немає правильних чи неправильних відповідей - головне щира комунікація ❤️. Рекомендований час гри: 15-30 хвилин за один сеанс ⏱️.",
        helpful: { yes: 89, no: 1 }
    },
    {
        id: 3,
